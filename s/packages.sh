...
xfe i3 j4-dmenu-desktop i3lock feh rofi i3status \    # i3 minimum dependencies
...
FeatherPad featherpad geany \           # the preferred minimal gui text editors
...
atom sublime-text3 sublime-merge vscode font-spleen \                 # IDE, etc
...
ffmpeg fswebcam streamer webcam moc soundconverter \
curl  gdebi\
...
pcmanfm ranger  zathura okular mupdf xpdf qdirstat lib32z1 \
